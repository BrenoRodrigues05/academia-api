...
📖 Detalhes completos das regras em docs/RBAC.md
...
docs/ENTIDADES.md — Estrutura do projeto, entidades e relacionamentos
docs/REGRAS-NEGOCIO.md — Regras de negócio
docs/ENDPOINTS.md — Endpoints da API
docs/ERROS.md — Tratamento de erros e exceptions
docs/BANCO-DE-DADOS.md — Configuração e migrations Flyway
...
👨‍💻 Autor
Breno Rodrigues — Desenvolvedor Full Stack GitHub
